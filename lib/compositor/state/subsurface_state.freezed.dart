...
abstract class $SubsurfaceStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, Offset position});
}
...
class _$_SubsurfaceState implements _SubsurfaceState {
  const _$_SubsurfaceState({required this.id, required this.position});
  ...
  @override
  String toString() {
    return 'SubsurfaceState(id: $id, position: $position)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, const DeepCollectionEquality().hash(position));
...
abstract class _SubsurfaceState implements SubsurfaceState {
  const factory _SubsurfaceState(
      ...
      required final Offset position}) = _$_SubsurfaceState;
