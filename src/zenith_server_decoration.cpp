// #include <memory>
// #include <utility>
// #include "zenith_server_decoration.hpp"
// #include "server.hpp"
//
// void server_decoration_create_handle(wl_listener* listener, void* data) {
// 	auto* server_toplevel_decoration = static_cast<wlr_server_decoration_v1*>(data);
//   wlr_server_decoration_set_mode(server_toplevel_decoration,
//                                           WLR_XDG_TOPLEVEL_DECORATION_V1_MODE_SERVER_SIDE);
//
// // ZenithServerDecoration::ZenithServerDecoration(wlr_server_decoration* wlr_server_decoration,
// //                                                    std::shared_ptr<ZenithXdgSurface> xdg_surface)
// // 	  : wlr_server_decoration(wlr_server_decoration), xdg_surface(std::move(xdg_surface)) {
// //
